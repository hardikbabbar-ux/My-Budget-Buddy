// Mobile Navigation Toggle - Fallback if desktop-navigation.js is not loaded
document.addEventListener('DOMContentLoaded', function() {
    // Check if desktop navigation is already handling this
    if (window.desktopNavigation) {
        console.log('📱 Desktop navigation is handling mobile menu, skipping fallback');
        return;
    }
    
    console.log('📱 Using fallback mobile navigation from script.js');
    ...
    if (hamburger && mobileNav) {
        ...
        document.querySelectorAll('.mobile-nav a').forEach(link => {
            link.addEventListener('click', () => {
                console.log('📱 Mobile menu link clicked (fallback)');
