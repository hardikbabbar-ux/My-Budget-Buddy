...
class PiggyBank {
    ...
    createGoal() {
        ...
        console.log('Goal data:', { name, amount, deadline, category, description });
        ...
        console.log('Goal object created:', goal);

        this.goals.push(goal);
        console.log('Goals array after push:', this.goals);
        
        this.saveData();
        console.log('Data saved to localStorage');
        
        this.updateSavingsOverview();
        this.updateGoalsList(); // Explicitly call updateGoalsList
    ...
    updateGoalsList() {
        ...
        console.log('Number of goals:', this.goals.length);
        ...
        if (this.goals.length === 0) {
            ...
            `;
            console.log('Displayed no goals message');
            return;
        }
        ...
        console.log('Goals list HTML updated');
        console.log('Final goalsList innerHTML length:', goalsList.innerHTML.length);
    }
    ...
    deductFromBudget(amount, description) {
        ...
        if (window.expenseManager) {
            ...
            window.expenseManager.reloadUI();
        } else {
...
// Debug function to test goal creation
window.testGoalCreation = function() {
    ...
    // Check if goal modal elements exist
    const goalNameInput = document.getElementById('goalName');
    const goalAmountInput = document.getElementById('goalAmount');
    const goalsList = document.getElementById('goalsList');
    
    console.log('Goal name input:', goalNameInput);
    console.log('Goal amount input:', goalAmountInput);
    console.log('Goals list container:', goalsList);
    
    // Check current goals
    console.log('Current goals:', window.piggyBank.goals);
    
    // Test creating a goal programmatically
    console.log('Creating test goal...');
    
    if (goalNameInput && goalAmountInput) {
        goalNameInput.value = 'Test Goal';
        goalAmountInput.value = '5000';
        document.getElementById('goalDeadline').value = '2024-12-31';
        
        console.log('Form filled, calling createGoal...');
        window.piggyBank.createGoal();
    } else {
        console.error('❌ Goal form elements not found');
    }
    
    console.log('=== END GOAL TEST ===');
};
